...
base_dir = Path('/tensorfl_vision/Web_Dev_AI')
...
class yolov7_json_handle:
    ...
    def __init__(self):
        ...
        self.template_dir = '/tensorfl_vision/Web_Dev_AI/templates'
        self.static_folder = '/tensorfl_vision/Web_Dev_AI/static'
        ...
        self.UPLOAD_FOLDER = '/tensorfl_vision/Web_Dev_AI/static/uploads/'
        ...
        self.path_to_classes = base_dir / 'models/coco-classes.txt'
        self.image_path = base_dir / 'Images'
        self.path_to_cfg_yolov7 = '/tensorfl_vision/Web_Dev_AI/models/yolov7-tiny.cfg'
        self.path_to_weight_yolov7 ='/tensorfl_vision/Web_Dev_AI/models/yolov7-tiny.weights'
        self.flask_path = '/tensorfl_vision/Web_Dev_AI/static/uploads'
            ...
            if file and self.allowed_file(file.filename):
               ...
               # print('**************',file_path, filename)
                ...
                if getImagesInference:
                    ...
                    relative_paths = [os.path.relpath(img_path, '/tensorfl_vision/Web_Dev_AI/static') for img_path in getImagesInference]
